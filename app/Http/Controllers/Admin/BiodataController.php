...
class BiodataController extends Controller
{
    ...
    public function store(BiodataRequest $request)
    {
        ...
        return redirect(route('admin.biodatas.create'))->with('success', trans('action.store.success', ['module' => 'Biodata']));
    }
    ...
    public function password(BiodataPasswordRequest $request)
    {
        ...
        return redirect(route('admin.biodatas.create'))->with('success-password', 'Change password success!');
    }
